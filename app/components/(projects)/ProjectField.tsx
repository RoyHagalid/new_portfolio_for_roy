  ...
  return (
    <div className="py-10 space-y-4">
      ...
      <div className="w-full flex justify-start">
        <span className="text-sm md:text-base font-rubik text-[#444] pl-4 pt-2">This site is handcrafted by me (with help) using Next.js, React, Tailwind CSS, and Sanity.io.</span>
      </div>
      {/* Highlighted section - stretched full width */}
      <div className="w-full rounded-lg p-2 flex flex-col">
        {/* Title section - 10% of height */}
        <div className="flex items-center justify-start mt-8 mb-2 py-2">
          <p className="text-left text-[#181818] font-libre-baskerville text-3xl font-bold tracking-wide">Featured Projects</p>
        </div>
        {/* Grid for highlighted project cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 auto-rows-max justify-center items-center">
      ...
      <div className="w-full flex flex-col">
        ...
        <div className="flex items-center justify-start p-2 mb-2">
          <p className="text-left text-[#181818] font-libre-baskerville text-3xl font-bold tracking-wide">Other Projects</p>
        </div>
        {/* Large scalable box for project cards */}
        <div className="w-full rounded-lg p-2 min-h-[800px]">
          <div className="grid grid-cols-1 grid-cols-between xl:grid-cols-3 grid-cols-between-max gap-x-2 gap-y-8 md:gap-x-8 md:gap-y-12 items-start justify-items-center">
